<template>
	<div id="introduce" >
		...
		<div class="phoneBtn">
			<a style="color: #fff;" :href="'tel:' + list.phone">联系司机</a>
		</div>
	</div>
</template>
...
<script>
	...
	export default{
		...
		methods: {
			...
			getlist(){
				this.axios.get('/api/drivers/api?id='+this.$route.query.id)
				.then(response=>{
...
<style scoped="scoped">
	...
	.phoneBtn{background: #006F3E;color: #fff;text-align: center;line-height: 40px;position: fixed;bottom: 0;width: 100%;}
</style>